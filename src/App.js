...
export default function App() {
            ...
            {posts.map((post) => (
              <tr key={post.postId}>
                ...
                <td>
                  ...
                  <button onClick={() => {if(window.confirm('Are you sure you want to Delete the post?')) deletePost(post.postId)}} className="btn btn-secondary btn-lg">Delete</button>
                </td>
              </tr>
            ))}
          </tbody>
  ...
  function onPostCreated(createdPost) {
    ...
    alert(`Post created successfully! Title: "${createdPost.title}`);
    getPosts();
  }
  ...
  function onPostUpdated(updatedPost) {
    ...
    setPosts(postsCopy);
    alert(`Post updated successfully! Title: "${updatedPost.title}`);
  }
