const API_BASE_URL_DEVELOPMENT = "https://localhost:7200";
const API_BASE_URL_PRODUCTION = "https://posts-backend.azurewebsites.net/";
...
const production = {
    ...
    API_URL_GET_POST_BY_UD: `${API_BASE_URL_PRODUCTION}/${ENDPOINTS.GET_POSTS_BY_ID}`,
